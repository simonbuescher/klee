...
void ADDExecutor::executeInstruction(ExecutionState &state, KInstruction *kInstruction, FunctionEvaluation *functionEvaluation, KFunction *kFunction, std::vector<llvm::BasicBlock *>::iterator blockInPathIt) {
    ...
    switch (instruction->getOpcode()) {
        ...
        case llvm::Instruction::ExtractValue: {
            ...
            ref<Expr> result = ExtractExpr::create(agg, kgepi->offset*8, getWidthForLLVMType(instruction->getType()));
        ...
        case llvm::Instruction::AtomicCmpXchg:
            assert(false && "Unexpected AtomicCmpXchg instruction, should be lowered by LowerAtomicInstructionPass");
